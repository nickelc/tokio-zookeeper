...
//!
//! [`create`]: struct.ZooKeeper.html#method.create
//! [`delete`]: struct.ZooKeeper.html#method.delete
//! [`exists`]: struct.ZooKeeper.html#method.exists
//! [`get_data`]: struct.ZooKeeper.html#method.get_data
//! [`set_data`]: struct.ZooKeeper.html#method.set_data
//! [`get_children`]: struct.ZooKeeper.html#method.get_children
